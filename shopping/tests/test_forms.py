...
class FormTest(TestCase):
    ...
    def test_form_signup_invalid_password(self):
        """ Form Test: 8 """
        data = {
            'username': 'test-user-invalid',
            'first_name': 'Test',
    ...
    def test_form_signup_invalid_password_different(self):
        """ Form Test: 10 """
        data = {
            'username': 'test-user-invalid',
            'first_name': 'Test',
    ...
    def test_form_signup_invalid_phone(self):
        """ Form Test: 11 """
        data = {
            'username': 'test-user-invalid',
            'first_name': 'Test',
    ...
    def test_form_signup_invalid_address(self):
        """ Form Test: 13 """
        data = {
            'username': 'test-user-invalid',
            'first_name': 'Test',
    ...
    def test_form_basket_add_invalid_quantity(self):
        """ Form Test: 16 """
        data = {}
        form = BasketAddItemForm(data=data)
        self.assertTrue(form.is_valid() is False)
    ...
    def test_form_payment_invalid_name(self):
        """ Form Test: 18 """
        data = {
            'card_number': "1234567890123456",
            "expire_info": "12/26"
    ...
    def test_form_payment_invalid_card_number(self):
        """ Form Test: 19 """
        data = {
            'name': "TEST USER",
            "expire_info": "12/26"
    ...
    def test_form_payment_invalid_expire_info(self):
        """ Form Test: 21 """
        data = {
            'name': "TEST USER",
            'card_number': "1234567890123456",
